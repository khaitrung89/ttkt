...
import 'userinput_model.dart';
export 'userinput_model.dart';

class UserinputWidget extends StatefulWidget {
  const UserinputWidget({super.key});

  static String routeName = 'userinput';
  static String routePath = '/userinput';
...
class _UserinputWidgetState extends State<UserinputWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UserinputModel());
            ...
            children: [
              ...
              if (_model.onerepmax != null)
                Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 1.0, 0.0, 0.0),
                  child: Text(
                    '${_model.onerepmax?.toString()} lbs'.maybeHandleOverflow(
                      maxChars: 7,
                    ),
                    style: FlutterFlowTheme.of(context).bodyMedium.override(
                          fontFamily: 'Inter',
